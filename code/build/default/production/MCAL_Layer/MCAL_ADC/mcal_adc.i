# 1 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/MCAL_ADC/mcal_adc.c" 2
...
# 12 "MCAL_Layer/MCAL_ADC/../GPIO/../std_libraries.h"
...
# 30 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Intialization(const ADC_Conf_t *adc_)
{
...
# 91 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_DeIntialization(const ADC_Conf_t *adc_)
{
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == adc_ )
...
# 124 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Channel_Selection(const ADC_Conf_t *adc_,ADC_Channel_Selection_t channel)
{
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == adc_ )
...
# 147 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Start_Conversion(const ADC_Conf_t *adc_)
{
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == adc_ )
...
# 169 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Is_Conversion_Done(const ADC_Conf_t *adc_ ,uint8 *conversion_status)
{
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == adc_ || ((void*)0) == conversion_status)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 201 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Get_Conversion_Result(const ADC_Conf_t *adc_ ,uint16 *conversion_Result)
{
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
    if(((void*)0) == adc_ || ((void*)0) == conversion_Result)
    {
        ret = (Std_ReturnType)0x00;
    }
    else
...
# 237 "MCAL_Layer/MCAL_ADC/mcal_adc.c"
Std_ReturnType ADC_Get_Conversion_Blocking_Mode(const ADC_Conf_t *adc_ ,uint16 *conversion_Result
                                  ,ADC_Channel_Selection_t channel)
  {
   Std_ReturnType ret = (Std_ReturnType)0x01 ;
...
static void ADC_Set_Channel_As_Inbut(ADC_Channel_Selection_t channel)
{
    switch(channel)
    {
        case ADC_CHANNEL_AN0 : (TRISA|=((uint8)1 <<0x1)); break;
...
static void ADC_Select_Voltage_Reference(const ADC_Conf_t *adc_ )
{
    if(0x01U == adc_->voltage_ref)
    {
        do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1; }while(0);;
    }
    else if(0x00U == adc_->voltage_ref)
    {
        do{ADCON1bits.VCFG0 = 0; ADCON1bits.VCFG1 = 0; }while(0);;
    }
    else
    {
        do{ADCON1bits.VCFG0 = 1; ADCON1bits.VCFG1 = 1; }while(0);;
