...
# 12 "MCAL_Layer/Timer1/mcal_timer1.h"
...
# 12 "MCAL_Layer/Timer1/../GPIO/../std_libraries.h"
...
Std_ReturnType Timer1_Intialization(const Timer1_conf_t *timer1_)
{
    ...
    else
    {
        ...
        (T1CONbits.T1CKPS = timer1_->Prescaler_Select);
...
# 57 "MCAL_Layer/Timer1/mcal_timer1.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
static void Timer1_Mode_Select(const Timer1_conf_t *timer1_)
{
    if(0 == timer1_->Timer1_Mode)
    {
        (T1CONbits.TMR1CS = 0);
    }
    else if(1 == timer1_->Timer1_Mode)
    {
        (T1CONbits.TMR1CS = 1);
        if (0 == timer1_->Timer1_Counter_Sync_Mode) {
            (T1CONbits.T1SYNC = 0);
        } else if (1 == timer1_->Timer1_Counter_Sync_Mode) {
            (T1CONbits.T1SYNC = 1);
        } else {
...
void TIMER1_ISR(void)
{
    ...
    if(((void*)0) == TIMER1_IntterruptHandeler){}
    else{
