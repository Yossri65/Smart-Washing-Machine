# 1 "MCAL_Layer/Timer0/mcal_timer0.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timer0/mcal_timer0.c" 2
...
# 12 "MCAL_Layer/Timer0/mcal_timer0.h"
...
# 12 "MCAL_Layer/Timer0/../GPIO/../std_libraries.h"
...
# 60 "MCAL_Layer/Timer0/mcal_timer0.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
static void Timer0_Prescaler_Config(const Timer0_conf_t *timer0_)
{
    if(0 == timer0_->TIMER0_PRESCALER_STATUS)
    {
        (T0CONbits.PSA = 0);
        T0CONbits.T0PS = timer0_->Prescaler_Select;
    }
    else if(1 == timer0_->TIMER0_PRESCALER_STATUS)
    {
        (T0CONbits.PSA = 1);
    }
    else{ }
...
static void Timer0_Bit_Mode_Select(const Timer0_conf_t *timer0_)
{
    if(1 == timer0_->Timer0_SELECT_BIT_Mode)
    {
        (T0CONbits.T08BIT = 1);
    }
...
void TIMER0_ISR(void)
{
    ...
    if(((void*)0) == TIMER0_IntterruptHandeler){}
    else{
