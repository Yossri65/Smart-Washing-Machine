# 1 "MCAL_Layer/Timer3/mcal_timer3.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/Timer3/mcal_timer3.c" 2
...
# 11 "MCAL_Layer/Timer3/mcal_timer3.h"
...
# 12 "MCAL_Layer/Timer3/../GPIO/../std_libraries.h"
...
Std_ReturnType timer3_init(const timer3_t *_timer){
    ...
    if(_timer == ((void*)0)) ret = (Std_ReturnType)0x00;
    else{
...
# 56 "MCAL_Layer/Timer3/mcal_timer3.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
...
# 109 "MCAL_Layer/Timer3/mcal_timer3.c"
Std_ReturnType timer3_read_value(const timer3_t *_timer, uint16 *_value){
    Std_ReturnType ret = (Std_ReturnType)0x01;
    uint8 tmr3_low = 0, tmr3_high = 0;
    if(_timer == ((void*)0) || _value == ((void*)0)) ret = (Std_ReturnType)0x00;
    else{
        tmr3_low = TMR3L;
        tmr3_high = TMR3H;
...
static __attribute__((inline)) void Timer3_mode_select(const timer3_t *_timer){
    if((_timer->timer3_mode) == 0){
        (T3CONbits.TMR3CS = 0);
    }else{
        (T3CONbits.TMR3CS = 1);
        if((_timer->timer3_counter_mode) == 0){
            (T3CONbits.T3SYNC = 0);
        }else{
            (T3CONbits.T3SYNC = 1);
        }
