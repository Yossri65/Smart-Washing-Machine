...
# 7 "MCAL_Layer/CCP1/hal_ccp.c" 2
   ...
   interruptHandler CCP2_IntterruptHandeler = ((void*)0);
...
{
    if (CCP1_SELECT == _CCP_->CCP_Select) {
        if (0x0C == _CCP_->ccp_mode_varient) {
            (CCP1CONbits.CCP1M =0x0C);
        } else {
    ...
    PR2 = (uint8) ((700000UL / ((float)(_CCP_->PWM_Frequncy) * 4.0 * (float)(_CCP_->Postscaler_Select) * (float)(_CCP_->Prescaler_Select))) - 1.0);
    ...
    if (CCP1_SELECT == _CCP_->CCP_Select)
            {
                switch(_CCP_->ccp_mode_varient)
                {
                    ...
                    break;
                    case 0x06:
                        (CCP1CONbits.CCP1M =0x06);
                    break;
                    case 0x07:
                        (CCP1CONbits.CCP1M =0x07);
                    break;
            ...
            else if (CCP2_SELECT == _CCP_->CCP_Select)
            {
                switch(_CCP_->ccp_mode_varient)
                {
                    ...
                    break;
                    case 0x06:
                        (CCP2CONbits.CCP2M =0x06);
                    break;
                    case 0x07:
                        (CCP2CONbits.CCP2M =0x07);
                    break;
                }
            }
    ...
    if (CCP1_SELECT == _CCP_->CCP_Select)
            {
                ...
                {
                    case 0x08:
                        (CCP1CONbits.CCP1M =0x08);
                    break;
                    case 0x09:
                        (CCP1CONbits.CCP1M =0x09);
                    break;
                    case 0x02:
                        (CCP1CONbits.CCP1M =0x02);
                    break;
                    case 0x0A:
                        (CCP1CONbits.CCP1M =0x0A);
                    break;
                    case 0x0B:
                        (CCP1CONbits.CCP1M =0x0B);
                    break;
                }
            }
            else if (CCP2_SELECT == _CCP_->CCP_Select)
            {
                 ...
                 {
                     case 0x08:
                         (CCP2CONbits.CCP2M =0x08);
                     break;
                     case 0x09:
                         (CCP2CONbits.CCP2M =0x09);
                     break;
                     case 0x02:
                         (CCP2CONbits.CCP2M =0x02);
                     break;
                     case 0x0A:
                         (CCP2CONbits.CCP2M =0x0A);
                     break;
                     case 0x0B:
                         (CCP2CONbits.CCP2M =0x0B);
                     break;
                 }
            }
            CCP_Capture_Compare_Timer_Selection(_CCP_);
