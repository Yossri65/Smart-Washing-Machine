# 1 "MCAL_Layer/USART/hal_usart.c"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 288 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/USART/hal_usart.c" 2
...
# 7 "MCAL_Layer/USART/hal_usart.c" 2
   ...
   interruptHandler USART_RX_IntterruptHandeler_ = ((void*)0);
   interruptHandler EUSART_FRAMINGERRORDefaultHandler_ = ((void*)0);
   interruptHandler EUSART_OVERRUNERRORDefaultHandler_ = ((void*)0);
...
static void EUSART_Baud_Rate_Calculation(const USART_CONFIG_t *_usart)
{
    ...
    switch(_usart->buad_rate_gen)
    {
        case BAUDRATE_ASYN_8BIT_lOW_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 0;
            baudrate_temp = ((700000UL /(float)_usart->baudrate)/64) - 1;
        break;
        case BAUDRATE_ASYN_8BIT_HIGH_SPEED:
            TXSTAbits.SYNC = 0;
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((700000UL /(float)_usart->baudrate)/16.0) - 1;
        ...
        case BAUDRATE_ASYN_16BIT_HIGH_SPEED:
            ...
            BAUDCONbits.BRG16 = 0;
            TXSTAbits.BRGH = 1;
            baudrate_temp = ((700000UL /(float)_usart->baudrate)/4) - 1;
        break;
...
static void EUSART_ASYNC_TX_CONFIG(const USART_CONFIG_t *_usart)
{
    ...
    {
        TXSTAbits.TXEN = 1;
        if(1 == _usart->UART_TX_Enable.TX_Interrupt_Enable)
        {
            PIE1bits.TXIE = 1;
...
# 208 "MCAL_Layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);



        }else if(0 == _usart->UART_TX_Enable.TX_Interrupt_Enable)
        {
            PIE1bits.TXIE = 0;
        }else{ }

        if(1 == _usart->UART_TX_Enable.TX_9Bit_Enable)
        {
            TXSTAbits.TX9 = 1;

        }else if(0 == _usart->UART_TX_Enable.TX_9Bit_Enable)
        {
            TXSTAbits.TX9 = 0;
...
static void EUSART_ASYNC_RX_CONFIG(const USART_CONFIG_t *_usart)
{
    ...
    {
        RCSTAbits.CREN = 1;
        if(1 == _usart->UART_RX_Enable.RX_Interrupt_Enable)
        {
            PIE1bits.RCIE = 1;
...
# 259 "MCAL_Layer/USART/hal_usart.c"
            (INTCONbits.GIE = 1);
            (INTCONbits.PEIE = 1);



        }else if(0 == _usart->UART_RX_Enable.RX_Interrupt_Enable)
        {
            PIE1bits.RCIE = 0;
        }else{ }

        if(1 == _usart->UART_RX_Enable.RX_9Bit_Enable)
        {
            RCSTAbits.RX9 = 1;

        }else if(0 == _usart->UART_RX_Enable.RX_9Bit_Enable)
        {
            RCSTAbits.RX9 = 0;
...
void USART_TX_ISR(void)
{
    ...
    PIE1bits.TXIE = 0;
    if(((void*)0) == USART_TX_IntterruptHandeler_){}
    else{
...
void USART_RX_ISR(void)
{
    ...
    if(((void*)0) == USART_RX_IntterruptHandeler_){}
    else{
        USART_RX_IntterruptHandeler_ ();
    }
    if(((void*)0) == EUSART_FRAMINGERRORDefaultHandler_){}
    else{
        EUSART_FRAMINGERRORDefaultHandler_ ();
    }
    if(((void*)0) == EUSART_OVERRUNERRORDefaultHandler_){}
    else{
