...
# 2 "<built-in>" 2
# 1 "MCAL_Layer/ECCP/hal_eccp.c" 2
...
Std_ReturnType ECCP_intialize(const ECCP_CONFIG_t *_ECCP_)
{
    ...
    if(_ECCP_ == ((void*)0))
    {
        ret = (Std_ReturnType)0x00;
            ...
            (CCP1CONbits.P1M = _ECCP_->PWM_Pins_Mode);
            ...
            PR2 = (uint8)((700000UL / ((_ECCP_->PWM_Frequncy) * 4.0 * (_ECCP_->Postscaler_Select) * (_ECCP_->Prescaler_Select))) - 1.0);
            PWM1CONbits.PDC = _ECCP_->delay /(4.0 *700000UL) ;
...
# 115 "MCAL_Layer/ECCP/hal_eccp.c"
        (INTCONbits.GIE = 1);
        (INTCONbits.PEIE = 1);
