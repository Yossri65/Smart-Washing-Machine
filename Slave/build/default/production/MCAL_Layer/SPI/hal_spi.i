...
# 12 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_config.h"
# 1 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_gen_cfg.h" 1
# 12 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_config.h" 2
# 43 "MCAL_Layer/SPI/../Interrupt/mcal_interrupt_config.h"
...
Std_ReturnType SPI_Init(const SPI_Config *_SPI_)
{
    ...
    else
    {
        ...
        if(0 == _SPI_->spi_serial_clk_mod_select ||
                1 == _SPI_->spi_serial_clk_mod_select ||
                2 == _SPI_->spi_serial_clk_mod_select ||
                3 == _SPI_->spi_serial_clk_mod_select)
        {
            MSSP_SPI_Msster_Mode_GPIO_PIN_Configurations();
            SSPSTATbits.SMP = _SPI_->spi_control.SampleSelect;
        }
        else if(4 == _SPI_->spi_serial_clk_mod_select ||
                5 == _SPI_->spi_serial_clk_mod_select)
        {
...
static void MSSP_SPI_Slave_Mode_GPIO_PIN_Configurations(const SPI_Config *_SPI_)
{
    ...
    ret = GPIO_Pin_Direction_Intialize(&SPI_SCK);
     ...
     if(4 == _SPI_->spi_serial_clk_mod_select){
