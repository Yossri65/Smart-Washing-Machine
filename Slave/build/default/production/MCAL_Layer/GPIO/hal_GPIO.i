...
# 12 "MCAL_Layer/GPIO/../std_libraries.h"
...
Std_ReturnType GPIO_Pin_Direction_Intialize(const Pin_Config_t *_Pin_Config_)
{
    ...
    if(_Pin_Config_ == ((void*)0) || _Pin_Config_-> pin > (uint8)8 -1)
    {
    ...
    else
    {
        ...
        {
            case Direction_Outpt :
                (*Tris_Reg[_Pin_Config_->port]&= ~((uint8)1 <<_Pin_Config_->pin));
                break;
...
# 53 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Pin_Get_Direction_Status(const Pin_Config_t *_Pin_Config_ ,Direction_t *Dir_Status)
{
        Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Pin_Config_ == ((void*)0) || Dir_Status == ((void*)0) || _Pin_Config_-> pin > (uint8)8 -1)
    {
        ret = (Std_ReturnType)0x00 ;
    }
    else
    {
        *Dir_Status = ((*Tris_Reg[_Pin_Config_->port] >> _Pin_Config_->pin) & (uint8)1);
    }
    return ret;
}
# 75 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Pin_Write_Logic(const Pin_Config_t *_Pin_Config_ ,Logic_t Logic)
{
    ...
    else
    {
        ...
        {
            case Logic_Low :
                (*Lat_Reg[_Pin_Config_->port]&= ~((uint8)1 <<_Pin_Config_->pin));
                break;
            case Logic_High :
                (*Lat_Reg[_Pin_Config_->port]|=((uint8)1 <<_Pin_Config_->pin));
                break;
...
# 106 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Pin_Read_Logic(const Pin_Config_t *_Pin_Config_ ,Logic_t *Logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Pin_Config_ == ((void*)0) || Logic == ((void*)0) || _Pin_Config_-> pin > (uint8)8 -1)
    {
        ret = (Std_ReturnType)0x00 ;
    }
    else
    {
        *Logic = ((*Port_Reg[_Pin_Config_->port] >> _Pin_Config_->pin) & (uint8)1);
    }
    return ret;
}
...
# 147 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Pin_Intialize(const Pin_Config_t *_Pin_Config_)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Pin_Config_ == ((void*)0) )
    {
        ret = (Std_ReturnType)0x00 ;
    }
    else
...
{
        Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Port_Index_ > (uint8)5 -1 || Dir_Status == ((void*)0))
    {
        ret = (Std_ReturnType)0x00 ;
    }
    else
...
# 215 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Port_Write_Logic(Port_Index_t _Port_Index_ ,Logic_t Logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Port_Index_ > (uint8)5 -1)
...
# 236 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Port_Read_Logic(Port_Index_t _Port_Index_ ,Logic_t *Logic)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Port_Index_ > (uint8)5 -1 || Logic == ((void*)0))
    {
        ret = (Std_ReturnType)0x00 ;
    }
    else
...
# 257 "MCAL_Layer/GPIO/hal_GPIO.c"
Std_ReturnType GPIO_Port_Toggle_Logic(Port_Index_t _Port_Index_)
{
    Std_ReturnType ret = (Std_ReturnType)0x01;
    if(_Port_Index_ > (uint8)5 -1)
