...
int main(void) {
    ...
    while(1)
    {
        ...
        if(1 == Start_status){
            ...
            if(1 == water_level_status && 30 == water_level){
                flag_water = 1;
                ret = Dc_Motor_Stop(&dc_motor2);
            }else if(2 == water_level_status && 65 == water_level){
                flag_water = 1;
                ret = Dc_Motor_Stop(&dc_motor2);
            }else if(3 == water_level_status && 98 == water_level){
                flag_water = 1;
                ret = Dc_Motor_Stop(&dc_motor2);
            }else{
            ...
            if(1 == temp_level_status && 20 == temperature){
                flag_temp = 1;
            }else if(2 == temp_level_status && 30 == temperature){
                flag_temp = 1;
            }else if(3 == temp_level_status && 40 == temperature){
                flag_temp = 1;
            }else{ }
            ...
            if(1 == flag_temp && 1 == flag_water){
                ...
                if(1 == wash_level_status){

                    time_of_washing = 4;
                }else if(2 == wash_level_status){
                    time_of_washing = 8;
                ...
                while(minutes < time_of_washing){
                    ...
                    _delay((unsigned long)((500)*(700000UL/4000.0)));
